...
from .utils.laplace_heatmap import (generate_laplace_heatmaps,
                                     generate_unbiased_laplace_heatmaps)
...
class RLEHeatmap(BaseKeypointCodec):
    ...
    def encode(
        ...
        if self.unbiased:
            heatmaps, keypoint_weights = generate_unbiased_laplace_heatmaps(
                heatmap_size=self.heatmap_size,
                keypoints=keypoints / self.scale_factor,
                keypoints_visible=keypoints_visible,
                sigma=self.sigma)
        else:
            heatmaps, keypoint_weights = generate_laplace_heatmaps(
                heatmap_size=self.heatmap_size,
                keypoints=keypoints / self.scale_factor,
                keypoints_visible=keypoints_visible,
                sigma=self.sigma)
